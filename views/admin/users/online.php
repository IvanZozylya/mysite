...
<div class="container">
    <div class="row otstup">
        ...
        <div class="col-md-8">
            <ul>
                <h4><li class="btn btn-default"><a href="/user/online/1">User Online</a></li>
                <li class="btn btn-default"><a href="/user/online/0">User Offlane</a></li></h4>
            </ul>
            ...
            <?php foreach ($userOnline as $online) : ?>
                <ul>
                    <li><h4><b class="btn-default"><a href="/cabinet/<?php echo $online['id'];?>"><?php echo $online['name']; ?>
